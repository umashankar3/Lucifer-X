...
import re
from Lucifer.plugins.mybot import *
...
async def settings(event):
    ...
    await tgbot.send_message(event.chat_id,
                             poto,
                             f"This is the personal help bot of {LUCIFER_NAME}. You can contact me using this bot if necessary, or if I missed out your PM.",
                             buttons=[
                                     [Button.inline(
                                         "Deploy me for yourself", data="deployme")]
                             ])
