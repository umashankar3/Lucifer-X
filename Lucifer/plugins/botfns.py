...
@Lucifer.on(admin_cmd(pattern="stat$"))
@Lucifer.on(sudo_cmd(pattern="stat$", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern="wspr ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="wspr ?(.*)", allow_sudo=True))
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        ...
        await x.edit("Downloaded by [Lucifer](t.me/LuciferXSupport), via @gitdownloadbot")
