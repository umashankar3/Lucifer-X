...
fuk_uid = bot.uid
HELP_PIC = "https://telegra.ph/file/78bebb896c10ef6213066.jpg"
...
MESAG = (
    str(CUSTOM_PMPERMIT)
    if CUSTOM_PMPERMIT
    else "`𝚈𝙾𝙾 𝙷𝙴𝚁𝙴 𝙸𝚂 𝙻 U C I F E R 𝙿𝙼 𝚂𝙴𝙲𝚄𝚁𝙸𝚃𝚈! 𝙿𝙻𝙴𝙰𝚂𝙴 𝚆𝙰𝙸𝚃 𝚃𝙸𝙻𝙻 𝙼𝚈 𝙼𝙰𝚂𝚃𝙴𝚁 𝙰𝙿𝙿𝚁𝙾𝚅𝙴. 🤓"
)
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query.startswith("`ℓισи"):
            ...
            result = builder.article(
                ...
                buttons=[
                    [
                        Button.url("𝙻u c i f e r 𝚁𝙴𝙿𝙾", "https://github.com/kaal0408/Lucifer-X"),
                        Button.url(
                            "𝙳𝙴𝙿𝙻𝙾𝚈 𝙽𝙾𝚆",
                            "https://heroku.com/deploy?template=https://github.com/kaal0408/Lucifer-X",
                        ),
