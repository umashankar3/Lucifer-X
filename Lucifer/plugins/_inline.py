...
fuk_uid = bot.uid
HELP_PIC = "https://telegra.ph/file/42a423c45e4146cf8a94c.mp4"
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query.startswith("`ℓυcιғεя"):
            ...
            but += [[Button.url("🔰 Sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ »»", "t.me/Lucifer_support_group"), Button.url("🔰 Uᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ", "t.me/LuciferXupdates")]]
            ...
            result = builder.article(
                title="Stats",
                text=f"**Lucifer 𝚄𝙱 𝚂𝚃𝙰𝚃𝚂 𝙾𝙵 𝚃𝙷𝙴 [{DEFAULTUSER}](tg://user?id={myid})**\n\n__𝙱𝙾𝚃 𝙸𝚂 𝚂𝙼𝙾𝙾𝚃𝙷𝙻𝚈 𝚁𝚄𝙽𝙽𝙸𝙽𝙶, 𝙼𝙰𝚂𝚃𝙴𝚁!__\n\n(c) @Lucifer_support_group",
                buttons=[
            ...
            result = builder.article(
                ...
                buttons=[
                    [
                        Button.url("L U C I F E R 𝚁𝙴𝙿𝙾", "https://github.com/kaal0408/Lucifer-X"),
                        Button.url(
                            "𝙳𝙴𝙿𝙻𝙾𝚈 𝙽𝙾𝚆",
                            "https://heroku.com/deploy?template=https://github.com/kaal0408/Lucifer-X",
                        ),
